...
class InceptionV4(nn.Module):
    ...
    def __init__(self, A, B, C, k=192, l=224, m=256, n=384, num_classs=100):
        ...
        self.linear = nn.Linear(1536, num_classs)
...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, A, B, C, k=256, l=256, m=384, n=384, num_classs=100):
        super().__init__()
        self.stem = Inception_Stem(3)
        ...
        #"""Dropout (keep 0.8)"""
        self.dropout = nn.Dropout2d(1 - 0.8)
        self.linear = nn.Linear(2048, num_classs)
